...
<div class="mx-16">
  ...
  <div class="bg-[#B45FC1] mt-9 py-16 rounded-3xl first-letter px-36">
    ...
    <ul class="flex-wrap flex font-poppins mt-16 justify-between">
      {#each Object.entries(displayItems) as [displayItem, unit]}
        <li class="bg-orange-100 w-52 h-52 py-9 text-center mt-8 rounded-2xl">
          <h4 class="font-semibold text-2xl text-[#B45FC1]">
      ...
      <li>
        <ul>
          ...
          {#each selectedFoods as food}
            <li class="mb-9">
              <button
                class="font-poppins text-base font-medium bg-violet-500 px-5 py-2 rounded-full"
                on:click={() => {
